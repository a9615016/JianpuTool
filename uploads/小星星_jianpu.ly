...
< \note-mod "4" f'  \tweak #'Y-offset #3.0 \note-mod "6" a \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 4: %}
...
< \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4  \note-mod "0" r4  \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 9: %}
< \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "3" e \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" e4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #2.0 \note-mod "1" c'  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
...
< \note-mod "4" f'  \tweak #'Y-offset #3.0 \note-mod "6" a \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 12: %}
< \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4  \note-mod "0" r4  \note-mod "–" r4 } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="Y" { \transpose c c { \key c \major  \time 4/4 \tempo 4=95 c'4 c'4 g'4 g'4 | %{ bar 2: %} a'4 a'4 < c c' g' >2 | %{ bar 3: %} f'4 f'4 e'4 e'4 | %{ bar 4: %} d'4 d'4 < c e c' >2 | %{ bar 5: %} g'4 g'4 f'4 f'4 | %{ bar 6: %} e'4 e'4 < g, g d' >2 | %{ bar 7: %} g'4 g'4 f'4 f'4 | %{ bar 8: %} e'4 e'4 < g, g d' >2 | %{ bar 9: %} c'4 c'4 g'4 g'4 | %{ bar 10: %} a'4 a'4 < c c' g' >2 | %{ bar 11: %} f'4 f'4 e'4 e'4 | %{ bar 12: %} d'4 d'4 < c e c' >2 } } }
% === END MIDI STAFF ===


% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="Z" { \transpose c c { \key c \major  \time 4/4 < c e >2 < c c' >2 | %{ bar 2: %} < f, c' >2 r2 | %{ bar 3: %} < f, a >2 < c g >2 | %{ bar 4: %} < g, g >2 r2 | %{ bar 5: %} < c c' >2 < f, a >2 | %{ bar 6: %} < g, g >2 r2 | %{ bar 7: %} < c c' >2 < f, a >2 | %{ bar 8: %} < g, g >2 r2 | %{ bar 9: %} < c e >2 < c c' >2 | %{ bar 10: %} < f, c' >2 r2 | %{ bar 11: %} < f, a >2 < c g >2 | %{ bar 12: %} < g, g >2 r2 } } }
% === END MIDI STAFF ===
