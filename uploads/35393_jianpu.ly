...
%% === BEGIN JIANPU STAFF ===
   ...
   \override VerticalAxisGroup.staff-staff-spacing = #'((minimum-distance . 7) (basic-distance . 7) (stretchability . 0))
    ...
    \override Staff.Stem #'transparent = ##t
     \mark \markup{1=C} \time 3/4 \tempo 4=121  \note-mod "1" c4  \note-mod "1" c4  \note-mod "1" c4 ~ | %{ bar 2: %}
 \note-mod "1" c4
 \note-mod "5" g4  \note-mod "6" a4 | %{ bar 3: %}
 \note-mod "6" a4
\once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "5" g4
 ...
 \note-mod "5" g4  \note-mod "4" f4 | %{ bar 8: %}
 \note-mod "4" f4
 \note-mod "3" e4  \note-mod "3" e4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 9: %}
 \note-mod "2" d4
 ~  \note-mod "–" d4  \note-mod "5" g4 | %{ bar 10: %}
 \note-mod "5" g4
 \note-mod "4" f4  \note-mod "4" f4 | %{ bar 11: %}
 ...
 \note-mod "3" e4  \note-mod "2" d4 ~ | %{ bar 12: %}
 \note-mod "2" d4
 \note-mod "1" c4  \note-mod "1" c4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 13: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4  \note-mod "5" g4 | %{ bar 14: %}
 \note-mod "6" a4
 \note-mod "6" a4  \note-mod "5" g4 ~ | %{ bar 15: %}
...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="X" { \transpose c c { \key c \major  \time 3/4 \tempo 4=121 c'4 c'4 c'4 ~ | %{ bar 2: %} c'4 g'4 a'4 | %{ bar 3: %} a'4 g'2 | %{ bar 4: %} f'4 f'4 e'4 | %{ bar 5: %} e'4 d'4 d'4 | %{ bar 6: %} c'2 c'4 ~ | %{ bar 7: %} c'4 g'4 f'4 | %{ bar 8: %} f'4 e'4 e'4 | %{ bar 9: %} d'2 g'4 | %{ bar 10: %} g'4 f'4 f'4 | %{ bar 11: %} e'4 e'4 d'4 ~ | %{ bar 12: %} d'4 c'4 c'4 | %{ bar 13: %} c'2 g'4 | %{ bar 14: %} a'4 a'4 g'4 ~ | %{ bar 15: %} g'4 f'4 f'4 | %{ bar 16: %} e'4 e'4 d'4 | %{ bar 17: %} d'4 c'2 } } }
% === END MIDI STAFF ===
