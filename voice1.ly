...
\once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "2" d4
 ~  \note-mod "–" d4  \note-mod "1" c4 | %{ bar 11: %}
 \note-mod "1" c4
 \note-mod "5" g4  \note-mod "5" g4  \note-mod "6" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 12: %}
 \note-mod "5" g4
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "1" c4
 ~  \note-mod "–" c4 | %{ bar 13: %}
 \note-mod "4" f4
 \note-mod "4" f4  \note-mod "3" e4  \note-mod "3" e4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 14: %}
 \note-mod "6" a4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" a4  \note-mod "2" d4  \note-mod "2" d4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 15: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4  \note-mod "0" r4  \note-mod "–" r4 | %{ bar 16: %}
 \note-mod "0" r4
 \note-mod "–" r4  \note-mod "–" r4  \note-mod "–" r4 | %{ bar 17: %}
...
\once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "3" e4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ...
 ~  \note-mod "–" f4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 12: %}
 \note-mod "5" g4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "5" g4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 13: %}
 \note-mod "3" e4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" e4  \note-mod "0" r4  \note-mod "–" r4 | %{ bar 14: %}
 \note-mod "0" r4
 \note-mod "–" r4  \note-mod "–" r4  \note-mod "–" r4 | %{ bar 15: %}
...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="Y" { \time 4/4 c'4 c'4 g'4 g'4 | %{ bar 2: %} a'4 g'2 c'4 ~ | %{ bar 3: %} c'4 f'4 f'4 e'4 | %{ bar 4: %} e'4 a2 d'4 | %{ bar 5: %} d'4 c'2 g'4 | %{ bar 6: %} g'4 f'4 f'4 a4 ~ | %{ bar 7: %} a4 e'4 e'4 d'4 ~ | %{ bar 8: %} d'4 g'4 g'4 f'4 | %{ bar 9: %} f'4 a2 e'4 | %{ bar 10: %} e'4 d'2 c'4 | %{ bar 11: %} c'4 g'4 g'4 a'4 | %{ bar 12: %} g'2 c'2 | %{ bar 13: %} f'4 f'4 e'4 e'4 | %{ bar 14: %} a2 d'4 d'4 | %{ bar 15: %} c'2 r2 | %{ bar 16: %} R1 | %{ bar 17: %} R1 | %{ bar 18: %} R1 | %{ bar 19: %} R1 | %{ bar 20: %} R1 | %{ bar 21: %} R1 | %{ bar 22: %} R1 | %{ bar 23: %} R1 | %{ bar 24: %} R1 | %{ bar 25: %} R1 | %{ bar 26: %} R1 | %{ bar 27: %} r1 } }
% === END MIDI STAFF ===


% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="Z" { \time 4/4 e2 c'2 | %{ bar 2: %} a'4 c2 f,4 ~ | %{ bar 3: %} f,4 f,2 g4 ~ | %{ bar 4: %} g4 g2 e4 ~ | %{ bar 5: %} e4 c'2 f,4 ~ | %{ bar 6: %} f,4 g2 g4 ~ | %{ bar 7: %} g4 c'2 f,4 ~ | %{ bar 8: %} f,4 g2 g4 ~ | %{ bar 9: %} g4 e2 c'4 ~ | %{ bar 10: %} c'4 a'4 c2 | %{ bar 11: %} f,2 f,2 | %{ bar 12: %} g2 g2 | %{ bar 13: %} e2 r2 | %{ bar 14: %} R1 | %{ bar 15: %} R1 | %{ bar 16: %} R1 | %{ bar 17: %} R1 | %{ bar 18: %} R1 | %{ bar 19: %} R1 | %{ bar 20: %} R1 | %{ bar 21: %} R1 | %{ bar 22: %} R1 | %{ bar 23: %} R1 | %{ bar 24: %} R1 | %{ bar 25: %} R1 | %{ bar 26: %} R1 | %{ bar 27: %} r1 } }
% === END MIDI STAFF ===
