...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" d4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 9: %}
 \note-mod "2" d4
 ~  \note-mod "–" d4  \note-mod "5" g4  \note-mod "5" g4 | %{ bar 10: %}
 \note-mod "4" f4
 \note-mod "4" f4  \note-mod "3" e4  \note-mod "3" e4 \bar "|." } }
...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="X" { \time 4/4 a'4 a'4 g'2 | %{ bar 2: %} g'4 g'4 g'2 | %{ bar 3: %} f'4 f'4 e'4 e'4 | %{ bar 4: %} d'4 d'4 a'4 a'4 | %{ bar 5: %} g'4 g'4 f'4 f'4 | %{ bar 6: %} e'4 e'4 d'4 d'4 | %{ bar 7: %} g'4 g'4 f'4 f'4 | %{ bar 8: %} e'4 e'4 d'2 | %{ bar 9: %} d'2 g'4 g'4 | %{ bar 10: %} f'4 f'4 e'4 e'4 } }
% === END MIDI STAFF ===
