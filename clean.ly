...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="Y" { \transpose c c { \key c \major  \time 4/4 \tempo 4=95 c'4 c'4 g'4 g'4 | %{ bar 2: %} a'4 r4 < c' g' >2 | %{ bar 3: %} f'4 f'4 e'4 e'4 | %{ bar 4: %} d'4 d'4 c'2 | %{ bar 5: %} g'4 g'4 f'4 f'4 | %{ bar 6: %} e'4 e'4 d'2 | %{ bar 7: %} g'4 g'4 f'4 f'4 | %{ bar 8: %} e'4 e'4 d'2 | %{ bar 9: %} c'4 c'4 g'4 g'4 | %{ bar 10: %} a'4 r4 < c' g' >2 | %{ bar 11: %} f'4 f'4 e'4 e'4 | %{ bar 12: %} d'4 d'4 c'2 } } }
% === END MIDI STAFF ===


% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="Z" { \transpose c c { \key c \major  \time 4/4 r1 | %{ bar 2: %} c'2 r2 | %{ bar 3: %} a2 r2 | %{ bar 4: %} R1 | %{ bar 5: %} r2 a2 | %{ bar 6: %} R1 | %{ bar 7: %} r2 a2 | %{ bar 8: %} R1 | %{ bar 9: %} R1 | %{ bar 10: %} c'2 r2 | %{ bar 11: %} a2 r2 | %{ bar 12: %} R1 } } }
% === END MIDI STAFF ===
