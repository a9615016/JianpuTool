...
% === BEGIN MIDI STAFF ===
    \new RhythmicStaff { \new Voice="X" { \transpose c c { \key c \major  \time 4/4 r2. gis16 f16 f16 r16 | %{ bar 2: %} g16 r16 cis16 cis8 r4 gis16 r8 e16 r4 cis16 r4 cis4 r16 f16 r16 r4 a''16 c8 r2 r16 } } }
% === END MIDI STAFF ===
