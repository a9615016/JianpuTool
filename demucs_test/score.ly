...
]   \note-mod "0" r4  \note-mod "1" cis4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #2
 \note-mod "0" c16[
\set stemLeftBeamCount = #2
...
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "1" \once \tweak Accidental.extra-offset #'(0 . 0.7)c8-\tweak #'X-offset #0.6 _. ]
...
% === BEGIN MIDI STAFF ===
    \new RhythmicStaff { \new Voice="X" { \transpose c c { \key c \major  \time 4/4 r2. gis16 r16 f16 r16 | %{ bar 2: %} g16 r16 cis16 cis8 r4 gis16 r8 e16 r4 cis16 r4 cis4 r16 f16 d16 r4 a''16 c8 r2 r16 } } }
% === END MIDI STAFF ===
