...
% === BEGIN MIDI STAFF ===
    \new RhythmicStaff { \new Voice="X" { \transpose c des { \key c \major  \time 4/4 r1 | %{ bar 2: %} r4 r16 e16 r16 fis16 r16 bis,8 bis,8 r8. | %{ bar 3: %} r8 fis16 r8 dis16 r4 r16 bis,8 r8. | %{ bar 4: %} r8 bis,8. r8 e16 r4. gis''16 b,8 r2. } } }
% === END MIDI STAFF ===
