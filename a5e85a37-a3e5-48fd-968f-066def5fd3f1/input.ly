...
%% === BEGIN JIANPU STAFF ===
   ...
   \override VerticalAxisGroup.staff-staff-spacing = #'((minimum-distance . 7) (basic-distance . 7) (stretchability . 0))
    ...
    \override Staff.Stem #'transparent = ##t
     \mark \markup{1=C} \time 4/4 \tempo 4=95  \note-mod "1" c4  \note-mod "1" c4  \note-mod "5" g4  \note-mod "5" g4 | %{ bar 2: %}
 \note-mod "6" a4
 ...
 \note-mod "5" g4  \note-mod "4" f4  \note-mod "4" f4 | %{ bar 6: %}
 \note-mod "3" e4
 \note-mod "3" e4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "2" d4
 ~  \note-mod "–" d4 | %{ bar 7: %}
 \note-mod "5" g4
 \note-mod "5" g4  \note-mod "4" f4  \note-mod "4" f4 | %{ bar 8: %}
 \note-mod "3" e4
...
%% === BEGIN JIANPU STAFF ===
   ...
   \override VerticalAxisGroup.staff-staff-spacing = #'((minimum-distance . 7) (basic-distance . 7) (stretchability . 0))
    ...
    \override Staff.TimeSignature #'style = #'numbered
    \override Staff.Stem #'transparent = ##t
     \mark \markup{1=C} \time 4/4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "3" e \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" e4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #2.0 \note-mod "1" c'  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" c'4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 2: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4  \note-mod "0" r4  \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 3: %}
 \note-mod "6" a4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" a4  \note-mod "0" r4  \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 4: %}
< \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "3" e \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" e4 | %{ bar 5: %}
 \note-mod "0" r4
 \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "6" a4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 6: %}
< \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4 | %{ bar 7: %}
 \note-mod "0" r4
 \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "6" a4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 8: %}
< \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 9: %}
< \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "3" e \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" e4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #2.0 \note-mod "1" c'  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" c'4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 10: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4  \note-mod "0" r4  \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 11: %}
 \note-mod "6" a4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" a4  \note-mod "0" r4  \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 12: %}
< \note-mod "5" g'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "3" e \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" e4 } }
% === END JIANPU STAFF ===
...
%% === BEGIN JIANPU STAFF ===
 ...
 \note-mod "0" r4
 \note-mod "6" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "1" c4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" c4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 3: %}
 \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 | %{ bar 4: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 5: %}
< \note-mod "1" c'  \tweak #'Y-offset #2.0 \note-mod "1" c'  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" c'4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4 | %{ bar 6: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "–" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 7: %}
< \note-mod "1" c'  \tweak #'Y-offset #2.0 \note-mod "1" c'  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" c'4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4 | %{ bar 8: %}
 \note-mod "0" r4
 ...
 \note-mod "0" r4
 \note-mod "6" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "1" c4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" c4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 11: %}
 \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 < \note-mod "1" c'  \tweak #'Y-offset #3.0 \note-mod "5" g \tweak #'Y-offset #1.7 -\tweak #'X-offset #0.6 _.  >4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 | %{ bar 12: %}
 \note-mod "0" r4
...
%% === BEGIN JIANPU STAFF ===
   ...
   \override VerticalAxisGroup.staff-staff-spacing = #'((minimum-distance . 7) (basic-distance . 7) (stretchability . 0))
    ...
    \override Staff.TimeSignature #'style = #'numbered
    \override Staff.Stem #'transparent = ##t
     \mark \markup{1=C} \time 4/4  \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 2: %}
 \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4  \note-mod "0" r4  \note-mod "–" r4 | %{ bar 3: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | %{ bar 4: %}
 ...
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "–" r4 | %{ bar 9: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 10: %}
 \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4  \note-mod "0" r4  \note-mod "–" r4 | %{ bar 11: %}
 \note-mod "0" r4
 \note-mod "0" r4  \note-mod "0" r4  \note-mod "0" r4 | %{ bar 12: %}
...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="a" { \transpose c c { \key c \major  \time 4/4 \tempo 4=95 c'4 c'4 g'4 g'4 | %{ bar 2: %} a'4 r4 < c' g' >2 | %{ bar 3: %} f'4 f'4 e'4 e'4 | %{ bar 4: %} d'4 d'4 c'2 | %{ bar 5: %} g'4 g'4 f'4 f'4 | %{ bar 6: %} e'4 e'4 d'2 | %{ bar 7: %} g'4 g'4 f'4 f'4 | %{ bar 8: %} e'4 e'4 d'2 | %{ bar 9: %} c'4 c'4 g'4 g'4 | %{ bar 10: %} a'4 r4 < c' g' >2 | %{ bar 11: %} f'4 f'4 e'4 e'4 | %{ bar 12: %} d'4 d'4 c'2 } } }
% === END MIDI STAFF ===


% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="b" { \transpose c c { \key c \major  \time 4/4 < c e >2 < c c' >2 | %{ bar 2: %} c'2 r2 | %{ bar 3: %} a2 r2 | %{ bar 4: %} < g, g >2 < c e >2 | %{ bar 5: %} r2 a2 | %{ bar 6: %} < g, g >2 < g, g >2 | %{ bar 7: %} r2 a2 | %{ bar 8: %} < g, g >2 < g, g >2 | %{ bar 9: %} < c e >2 < c c' >2 | %{ bar 10: %} c'2 r2 | %{ bar 11: %} a2 r2 | %{ bar 12: %} < g, g >2 < c e >2 } } }
% === END MIDI STAFF ===


% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="c" { \transpose c c { \key c \major  \time 4/4 r1 | %{ bar 2: %} r4 a'4 c2 | %{ bar 3: %} f,2 < c g >2 | %{ bar 4: %} R1 | %{ bar 5: %} < c c' >2 f,2 | %{ bar 6: %} R1 | %{ bar 7: %} < c c' >2 f,2 | %{ bar 8: %} R1 | %{ bar 9: %} R1 | %{ bar 10: %} r4 a'4 c2 | %{ bar 11: %} f,2 < c g >2 | %{ bar 12: %} R1 } } }
% === END MIDI STAFF ===


% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="d" { \transpose c c { \key c \major  \time 4/4 r1 | %{ bar 2: %} f,2 r2 | %{ bar 3: %} R1 | %{ bar 4: %} R1 | %{ bar 5: %} R1 | %{ bar 6: %} R1 | %{ bar 7: %} R1 | %{ bar 8: %} R1 | %{ bar 9: %} R1 | %{ bar 10: %} f,2 r2 | %{ bar 11: %} R1 | %{ bar 12: %} R1 } } }
% === END MIDI STAFF ===
