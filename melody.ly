...
\once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "2" d4
 ...
 ~  \note-mod "–" e4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 16: %}
 \note-mod "1" c4
...
~ | %{ bar 24: %}
 \note-mod "3" e4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
\once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "1" c4
 ~  \note-mod "–" c4  \note-mod "6" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 25: %}
 \note-mod "1" c4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" c4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 26: %}
 \note-mod "4" f4-\tweak #'Y-offset #-2 -\tweak #'X-offset #0.6 _\two-dots 
 ~  \note-mod "–" f4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "5" g4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 27: %}
 \note-mod "5" g4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "3" e4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 ~  \note-mod "–" e4 \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="X" { \time 4/4 c'4 c'4 g'4 g'4 | %{ bar 2: %} a'4 g'2 c'4 ~ | %{ bar 3: %} c'4 f'4 f'4 e'4 | %{ bar 4: %} e'4 a2 d'4 | %{ bar 5: %} d'4 c'2 g'4 | %{ bar 6: %} g'4 f'4 f'4 a4 ~ | %{ bar 7: %} a4 e'4 e'4 d'4 ~ | %{ bar 8: %} d'4 g'4 g'4 f'4 | %{ bar 9: %} f'4 a2 e'4 | %{ bar 10: %} e'4 d'2 c'4 | %{ bar 11: %} c'4 g'4 g'4 a'4 | %{ bar 12: %} g'2 c'2 | %{ bar 13: %} f'4 f'4 e'4 e'4 | %{ bar 14: %} a2 d'4 d'4 | %{ bar 15: %} c'2 e2 | %{ bar 16: %} c'2 a'4 c4 ~ | %{ bar 17: %} c4 f,2 f,4 ~ | %{ bar 18: %} f,4 g2 g4 ~ | %{ bar 19: %} g4 e2 c'4 ~ | %{ bar 20: %} c'4 f,2 g4 ~ | %{ bar 21: %} g4 g2 c'4 ~ | %{ bar 22: %} c'4 f,2 g4 ~ | %{ bar 23: %} g4 g2 e4 ~ | %{ bar 24: %} e4 c'2 a'4 | %{ bar 25: %} c2 f,2 | %{ bar 26: %} f,2 g2 | %{ bar 27: %} g2 e2 } }
% === END MIDI STAFF ===
