...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 2: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4  \note-mod "4" f4  \note-mod "2" d4 | %{ bar 3: %}
 \note-mod "5" g4
 \note-mod "3" e4  \note-mod "5" g4  \note-mod "3" e4 | %{ bar 4: %}
 \note-mod "1" c4
 \note-mod "6" a4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "5" g4
 ~  \note-mod "–" g4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 5: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4  \note-mod "4" f4  \note-mod "2" d4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 6: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "1" c4
 ~  \note-mod "–" c4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 7: %}
 \note-mod "1" c4
 ~  \note-mod "–" c4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "1" c4
 ~  \note-mod "–" c4 | %{ bar 8: %}
 \note-mod "1" c4
...
\once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "2" d4
 ~  \note-mod "–" d4  \note-mod "4" f4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 13: %}
 \note-mod "2" d4
...
% === BEGIN MIDI STAFF ===
    \new JianpuStaff { \new Voice="X" { \time 4/4 c'4 a'4 g'2 | %{ bar 2: %} c'2 f'4 d'4 | %{ bar 3: %} g'4 e'4 g'4 e'4 | %{ bar 4: %} c'4 a'4 g'2 | %{ bar 5: %} c'2 f'4 d'4 | %{ bar 6: %} c'2 c'2 | %{ bar 7: %} c'2 c'2 | %{ bar 8: %} c'4 f'4 d'4 g'4 | %{ bar 9: %} e'4 g'4 e'4 c'4 | %{ bar 10: %} f'4 d'4 a'4 a'4 | %{ bar 11: %} g'4 e'4 c'2 | %{ bar 12: %} f'4 d'2 f'4 | %{ bar 13: %} d'2 g'4 e'4 | %{ bar 14: %} c'2 g'4 e'4 | %{ bar 15: %} f'4 f'4 g'4 e'4 } }
% === END MIDI STAFF ===
