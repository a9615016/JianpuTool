...
%% === BEGIN JIANPU STAFF ===
   ...
   \override VerticalAxisGroup.staff-staff-spacing = #'((minimum-distance . 7) (basic-distance . 7) (stretchability . 0))
    ...
    \override Staff.Stem.transparent = ##t
     \mark \markup{1=D\flat} \time 4/4  \note-mod "0" r4  \note-mod "–" r4  \note-mod "–" r4  \note-mod "–" r4 | %{ bar 2: %} \set stemLeftBeamCount = #2
\set stemRightBeamCount = #2
 \note-mod "5" \once \tweak Accidental.extra-offset #'(0 . 0.7)gis16-\tweak #'X-offset #0.6 _. [
...
\set stemLeftBeamCount = #2
\set stemRightBeamCount = #2
 \note-mod "4" \once \tweak Accidental.extra-offset #'(0 . 0.7)fis16-\tweak #'X-offset #0.6 _. ]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #2
 \note-mod "0" c16[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "7" \once \tweak Accidental.extra-offset #'(0 . 0.7)bis8-\tweak #'X-offset #0.6 _\two-dots 
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "7" bis8-\tweak #'X-offset #0.6 _\two-dots 
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "0" r8.]
...
\set stemLeftBeamCount = #2
\set stemRightBeamCount = #2
 \note-mod "2" \once \tweak Accidental.extra-offset #'(0 . 0.7)dis16-\tweak #'X-offset #0.6 _. 
...
\set stemRightBeamCount = #2
 \note-mod "3" e16-\tweak #'X-offset #0.6 _. ]
 \note-mod "0" r4. \set stemLeftBeamCount = #2
\set stemRightBeamCount = #2
 \note-mod "5" \once \tweak Accidental.extra-offset #'(0 . 0.7)gis16^.[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new RhythmicStaff { \new Voice="X" { \transpose c des { \key c \major  \time 4/4 r1 | %{ bar 2: %} gis16 r8 e8 e16 r16 fis16 r16 bis,8 bis,8 r8. | %{ bar 3: %} r8 fis16 r8 dis16 r4 r16 bis,8 r8. | %{ bar 4: %} r8 bis,8. r8 e16 r4. gis''16 b,8 r2. } } }
% === END MIDI STAFF ===
